...
import { NectarUIThemes, Themes } from 'components'
...
export type ConfigProviderProps = {
  onThemeChange?: (themes: DeepPartial<NectarUIThemes>) => void
...
const ConfigProvider: React.FC<React.PropsWithChildren<ConfigProviderProps>> = React.memo(
  ({
    ...
    const updateCustomTheme = (nextTheme: DeepPartial<NectarUIThemes>) => {
...
ConfigProvider.displayName = 'NectarConfigProvider'
