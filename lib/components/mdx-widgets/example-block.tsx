...
import { NectarUIThemes } from 'components/themes/presets'
...
const getBackground = (theme: NectarUIThemes, plain: number | boolean) => {
...
ExampleBlock.displayName = 'NectarExampleBlock'
