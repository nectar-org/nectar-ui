...
import { NectarUIThemesPalette } from 'components/themes'
const DefaultTheme = Themes.getPresetStaticTheme()

interface Props {
  value?: string
  keyName: keyof NectarUIThemesPalette
}
...
const getRandomColors = () => {
  const kyes = Object.keys(DefaultTheme.palette) as Array<keyof NectarUIThemesPalette>
