...
import { NectarUIThemesExpressiveness, NectarUIThemesPalette } from 'components/themes'

const basicColors: Array<keyof NectarUIThemesPalette> = [
  'accents_1',
  'accents_2',
  'accents_3',
  'accents_4',
...
const statusColors: Array<keyof NectarUIThemesPalette> = [
  'success',
  'successLight',
  'successDark',
  'error',
...
const otherColors: Array<keyof NectarUIThemesPalette> = [
  'selection',
  'secondary',
  'link',
  'border',
...
const expressiveness: Array<keyof NectarUIThemesExpressiveness> = [
  'linkStyle',
  'linkHoverStyle',
  'dropdownBoxShadow',
  'shadowSmall',
...
// const pageLayout: Array<keyof NectarUIThemesLayout> = [
//   'pageWidth',
//   'pageWidthWithMargin',
//   'pageMargin',
//   'radius',
// ]
// const gapLayout: Array<keyof NectarUIThemesLayout> = [
//   'gap',
//   'gapNegative',
//   'gapHalf',
//   'gapHalfNegative',
