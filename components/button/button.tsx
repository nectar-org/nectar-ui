      ...
      <button
        ...
        <style jsx>{`
          .btn {
            ...
            --nectar-ui-button-icon-padding: ${SCALES.pl(0.727)};
            --nectar-ui-button-height: ${SCALES.height(2.5)};
            --nectar-ui-button-color: ${color};
            --nectar-ui-button-bg: ${bg};
          ...
          .btn:focus {
            color: ${hover.color};
            --nectar-ui-button-color: ${hover.color};
...
ButtonComponent.displayName = 'NectarButton'
