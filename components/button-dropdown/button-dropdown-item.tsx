    ...
    <button className={className} onClick={clickHandler} {...props}>
      ...
      <style jsx>{`
        button {
          ...
          color: ${colors.color};
          width: 100%;
          height: var(--nectar-ui-dropdown-height);
          min-width: var(--nectar-ui-dropdown-min-width);
          padding: var(--nectar-ui-dropdown-padding);
          font-size: var(--nectar-ui-dropdown-font-size);
        }
...
ButtonDropdownItem.displayName = 'NectarButtonDropdownItem'
