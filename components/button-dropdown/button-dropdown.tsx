      ...
      <div
        ...
        <style jsx>{`
          .btn-dropdown {
            ...
            --nectar-ui-dropdown-height: ${SCALES.height(2.5)};
            --nectar-ui-dropdown-min-width: ${auto ? 'min-content' : SCALES.width(10.5)};
            --nectar-ui-dropdown-padding: ${SCALES.pt(0)} ${paddingRight} ${SCALES.pb(0)}
              ${paddingLeft};
            --nectar-ui-dropdown-font-size: ${SCALES.font(0.875)};
          }
...
ButtonDropdownComponent.displayName = 'NectarButtonDropdown'
