...
const Application: NextPage<{}> = () => {
  ...
  return (
    <>
      <div className="layout">
        ...
        <Grid.Container gap={2} justify="center">
          ...
          <Grid xs={24} md={8}>
            <HomeCell
              icon={<GitHubIcon />}
              url="https://github.com/nectar-org/nectar-ui"
              title="Open Sourced"
              desc="Nectar is open sourced and available free under MIT licence."
            />
          </Grid>
        </Grid.Container>
      </div>
      <style jsx>{`
        .layout {
          min-height: calc(100vh - var(--nectar-page-nav-height));
        ...
        .hero {
          height: calc(100vh - var(--nectar-page-nav-height) - 300px);
          min-height: 30vh;
          max-width: 500px;
          margin: 0 auto;
          text-align: center;
