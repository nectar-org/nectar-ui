...
<Playground
  ...
  scope={{ Input }}
  code={`
<Input placeholder="Nectar UI" width="100%" />
`}
/>
...
<Playground
  ...
  code={`
<>
  <Input label="username" placeholder="Nectar UI" />
  <Spacer h={.5} />
...
<Playground
  ...
  code={`
<>
  <Input type="secondary" initialValue="Nectar UI" />
  <Spacer h={.5} />
  <Input type="success" initialValue="Nectar UI" />
  <Spacer h={.5} />
  <Input type="warning" initialValue="Nectar UI" />
  <Spacer h={.5} />
  <Input type="error" initialValue="Nectar UI" />
</>
`}
/>
...
<Playground
  ...
  code={`
<>
  <Input clearable initialValue="Nectar UI" placeholder="Nectar UI" />
</>
`}
/>
...
() => {
  ...
  return (
    <Input value={value} onChange={handler} placeholder="Nectar UI" />
  )
}
`}
/>
