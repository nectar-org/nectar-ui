...
<Tabs initialValue="yarn">
  <Tabs.Item label="Yarn" value="yarn">
    <Spacer h={0.6} />
    <Snippet width="400px">yarn add @nectar-ui/icons</Snippet>
  </Tabs.Item>
  <Tabs.Item label="npm" value="npm">
    <Spacer h={0.6} />
    <Snippet width="400px">npm i @nectar-ui/icons</Snippet>
  </Tabs.Item>
</Tabs>
...
<Playground
  ...
  scope={{ Github, Spacer }}
  code={`
// import * as Icon from '@nectar-ui/icons'
// or
// import { Github } from '@nectar-ui/icons'
// or, for tree-shaking:
// import Github from '@geist-ui/icons/github'
