...
which gave the Nectar components amazing imagination and extensibility,
...
Now we try to bind the component to the scale of Nectar:

```tsx
import { withScale, useScale } from '@nectar-ui/core'
