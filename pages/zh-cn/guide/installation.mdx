...
此外，Nectar 是基于 React 框架的组件库，这意味着您也必须了解如何 [创建项目](https://zh-hans.reactjs.org/docs/hello-world.html) 与框架基础知识。
...
此外，这里有一个在 CRA 上使用 Nectar 的完整 [项目示例](https://github.com/nectar-org/react-getting-started) 供作参考。

### Next.js 项目

[Next.js](https://nextjs.org/) 是一个 React 服务端渲染框架。在 Next.js 上使用 Nectar 需要定制 `_app.jsx` 文件，
...
此外，我们也提供了一个完整的 [Next.js 应用](https://github.com/nectar-org/nectar-ui/blob/master/examples/create-next-app/README.md) 示例以供参考。
